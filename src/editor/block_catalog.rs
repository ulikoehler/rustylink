...
fn build_catalog() -> Vec<BlockCatalogEntry> {
    ...
    c.push(entry(
        ...
        0,
        1,
        "Load data from workspace variable",
    ));
    c.push(entry(
        "FromFile",
        "From File",
    ...
    c.push(entry(
        ...
        0,
        1,
        "Output simulation time at specified rate",
    ));
    ...
    c.push(entry(
        ...
        0,
        1,
        "White noise with specified bandwidth",
    ));
    c.push(entry(
        "Repeating",
        "Repeating Sequence",
        ...
        0,
        1,
        "Generate repeating arbitrary signal",
    ));
    c.push(entry(
        "RepeatingStair",
        ...
        0,
        1,
        "Generate repeating staircase signal",
    ));
    c.push(entry(
        "RepeatingInterp",
        ...
        0,
        1,
        "Repeating sequence with interpolation",
    ));
    c.push(entry(
        "Counter",
    ...
    c.push(entry(
        ...
        0,
        1,
        "Output enumerated type constant",
    ));
    c.push(entry(
        "TimeTableLookup",
        "Time Table Lookup",
    ...
    c.push(entry(
        "MultiPortSwGen",
        "Multi-port Waveform Generator",
        cat,
        0,
        1,
        "Multi-output waveform gen",
    ));
    c.push(entry(
        "Playback",
        "Playback",
    ...
    c.push(entry(
        ...
        1,
        0,
        "Display signal in scope window",
    ));
    c.push(entry(
        "FloatingScope",
        "Floating Scope",
    ...
    c.push(entry(
        ...
        1,
        0,
        "Write data to workspace variable",
    ));
    c.push(entry(
        "ToFile",
        "To File",
    ...
    c.push(entry(
        ...
        2,
        0,
        "Display XY plot of two signals",
    ));
    c.push(entry(
        "Stop",
        "Stop Simulation",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Common math function (exp, log, pow, etc.)",
    ));
    c.push(entry(
        "TrigFunction",
    ...
    c.push(entry(
        ...
        2,
        1,
        "Convert magnitude and angle to complex",
    ));
    c.push(entry(
        "RealImagToComplex",
        ...
        2,
        1,
        "Convert real and imag to complex",
    ));
    c.push(entry(
        ...
        1,
        2,
        "Extract magnitude and angle from complex",
    ));
    c.push(entry(
        "ComplexToRealImag",
        ...
        1,
        2,
        "Extract real and imag from complex",
    ));
    c.push(entry(
        "Reshape",
        "Reshape",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Sum all elements of vector/matrix",
    ));
    c.push(entry(
        "ProductOfElements",
        "Product of Elements",
    ...
    c.push(entry(
        ...
        2,
        1,
        "Output max of inputs with constraint",
    ));
    c.push(entry(
        "MinConstraint",
        "Min Constraint",
        ...
        2,
        1,
        "Output min of inputs with constraint",
    ));
    ...
    c.push(entry(
        ...
        1,
        1,
        "Detect nonnegative rising edge",
    ));
    c.push(entry(
        "DetectFallNeg",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Integrator with saturation limits",
    ));
    c.push(entry(
        ...
        1,
        2,
        "Second-order integrator (x, dx/dt)",
    ));
    c.push(entry(
        "Derivative",
        "Derivative",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Delay signal by one sample period",
    ));
    ...
    c.push(entry(
        ...
        1,
        1,
        "Discrete integration / accumulator",
    ));
    c.push(entry(
        "DiscreteDerivative",
        "Discrete Derivative",
    ...
    c.push(entry(
        ...
        2,
        1,
        "Unit delay with external reset",
    ));
    c.push(entry(
        "ZeroOrderHoldExact",
    ...
    c.push(entry(
        "DiscreteMedianFilter",
        "Discrete Median Filter",
        cat,
        1,
        1,
    ...
    c.push(entry(
        ...
        2,
        1,
        "Multiplex scalar signals into vector",
    ));
    c.push(entry(
        "Demux",
        "Demux",
        ...
        1,
        2,
        "Demultiplex vector into scalars",
    ));
    c.push(entry(
        "Switch",
        "Switch",
        ...
        3,
        1,
        "Switch between two inputs based on threshold",
    ));
    c.push(entry(
        "MultiPortSwitch",
        "Multiport Switch",
        ...
        3,
        1,
        "Select from multiple data inputs",
    ));
    c.push(entry(
        "ManualSwitch",
        "Manual Switch",
        ...
        2,
        1,
        "Manually toggle between two inputs",
    ));
    c.push(entry(
        "BusCreator",
        "Bus Creator",
        ...
        2,
        1,
        "Create bus signal from individual signals",
    ));
    c.push(entry(
        "BusSelector",
        "Bus Selector",
    ...
    c.push(entry(
        ...
        2,
        1,
        "Assign signals to bus elements",
    ));
    c.push(entry(
        "BusToVector",
        "Bus to Vector",
    ...
    c.push(entry(
        ...
        1,
        0,
        "Send signal to matching From block",
    ));
    c.push(entry(
        "From",
        "From",
        ...
        0,
        1,
        "Receive signal from matching Goto block",
    ));
    c.push(entry(
        "GotoTagVisibility",
        "Goto Tag Visibility",
    ...
    c.push(entry(
        ...
        2,
        1,
        "Assign values to vector/matrix elements",
    ));
    c.push(entry(
        "Concatenate",
        "Concatenate",
    ...
    c.push(entry(
        ...
        0,
        2,
        "Switch between sim and codegen",
    ));
    ...
    c.push(entry(
        ...
        2,
        1,
        "Subsystem with trigger port",
    ));
    c.push(entry(
        "EnabledTriggeredSubSystem",
        "Enabled and Triggered",
        cat,
        3,
        1,
        "Subsystem with enable and trigger",
    ));
    c.push(entry(
        ...
        2,
        1,
        "Conditional execution subsystem",
    ));
    c.push(entry(
        "ForEachSubSystem",
        "For Each Subsystem",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Configurable subsystem variant",
    ));
    c.push(entry(
        "VariantSubSystem",
        "Variant Subsystem",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Promote reusable code generation",
    ));
    c.push(entry(
        "MaskedSubSystem",
        "Masked Subsystem",
    ...
    c.push(entry(
        ...
        0,
        0,
        "Action port for if/switch subsystem",
    ));
    c.push(entry(
    ...
    c.push(entry(
        ...
        1,
        2,
        "Prelookup for interpolation index",
    ));
    c.push(entry(
        "InterpUsingPreLookup",
        "Interpolation Using Prelookup",
        cat,
        1,
        1,
        "Interpolate using prelookup result",
    ));
    c.push(entry(
        "DirectLookup",
    ...
    c.push(entry(
        ...
        3,
        1,
        "Lookup with dynamic breakpoints",
    ));
    c.push(entry(
        "LookupSine",
        "Sine Lookup",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Cosine approximation via table",
    ));
    ...
    c.push(entry(
        ...
        3,
        1,
        "Saturation with dynamic limits",
    ));
    c.push(entry(
        "DeadZone",
        "Dead Zone",
        ...
        1,
        1,
        "Zero output within dead zone band",
    ));
    c.push(entry(
        "DeadZoneDynamic",
        "Dead Zone Dynamic",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Quantize signal to fixed levels",
    ));
    c.push(entry(
        "Relay",
        "Relay",
        ...
        1,
        1,
        "Switch output on/off with hysteresis",
    ));
    c.push(entry(
        "WrappedToZero",
        "Wrap To Zero",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Butterworth/Chebyshev/Elliptic filter",
    ));
    c.push(entry(
        "DigitalFilter",
        ...
        1,
        1,
        "Design and apply digital filter",
    ));
    c.push(entry(
        "BiquadFilter",
        "Biquad Filter",
        ...
        1,
        1,
        "Second-order section (biquad) filter",
    ));
    c.push(entry(
        "MedianFilter",
        "Median Filter",
    ...
    c.push(entry(
        ...
        2,
        1,
        "Spring-damper mechanical element",
    ));
    c.push(entry(
        "RotationalSpring",
        "Rotational Spring",
    ...
    c.push(entry(
        ...
        2,
        1,
        "Rotate frame by angle/quaternion",
    ));
    c.push(entry(
        "FlatEarthDynamics",
        "Flat Earth Dynamics",
        ...
        4,
        4,
        "6-DOF flat earth equations of motion",
    ));
    c.push(entry(
        "WindModel",
        "Wind Model",
    ...
    c.push(entry(
        ...
        3,
        2,
        "Inertial navigation system filter",
    ));
    ...
    c.push(entry(
        ...
        1,
        1,
        "Unpack signals from CAN message",
    ));
    c.push(entry(
        "SharedMemoryRead",
        "Shared Memory Read",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Convert between RGB/HSV/YCbCr/Grayscale",
    ));
    c.push(entry(
        "EdgeDetection",
        "Edge Detection",
        ...
        1,
        1,
        "Detect edges (Sobel, Canny, Prewitt)",
    ));
    c.push(entry(
        "Morphology",
    ...
    c.push(entry(
        ...
        1,
        3,
        "Find and analyze connected regions",
    ));
    c.push(entry(
        "TemplateMatch",
        "Template Matching",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Extract image features (SURF, ORB)",
    ));
    c.push(entry(
        "OpticalFlow",
        "Optical Flow",
    ...
    c.push(entry(
        ...
        1,
        0,
        "Assert condition during simulation",
    ));
    c.push(entry(
        "CheckStaticRange",
        "Check Static Range",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Formal verification assumption",
    ));
    c.push(entry(
        "ProofObjective",
        "Proof Objective",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Reference to external subsystem file",
    ));
    ...
    c.push(entry(
        ...
        0,
        0,
        "Free text annotation (non-block)",
    ));
    c.push(entry(
        "ConfigurationBlock",
        "Configuration",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Set initial condition for signal",
    ));
    c.push(entry(
        "SimulationPace",
        "Simulation Pace",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Send/receive simulation messages",
    ));
    c.push(entry(
        "EntityGenerator",
        "Entity Generator",
    ...
    c.push(entry(
        ...
        3,
        4,
        "Six degrees of freedom (Euler angles)",
    ));
    c.push(entry(
        "AeroSixDOFQuat",
        "6DOF (Quaternion)",
        ...
        3,
        4,
        "Six degrees of freedom (quaternion)",
    ));
    c.push(entry(
        "AeroLLAtoECEF",
        "LLA to ECEF",
    ...
    c.push(entry(
        ...
        1,
        1,
        "Convert color spaces (RGB/HSV/YCbCr)",
    ));
    c.push(entry(
        "CVEdgeDetect",
        "Edge Detection",
    ...
    c.push(entry(
        ...
        1,
        0,
        "Assumption for design verifier",
    ));
    c.push(entry(
        "TestObjective",
        "Test Objective",
